...
const strAsset = {
  ...
  helpOne : [
    {desc : "1. 연결 버튼을 눌러 키트를 연결합니다.",
      img : HelpOne_One},
    {desc : "2. 원하는 모델 구조를 하나 선택합니다.",
      img : HelpOne_two},
    {desc : "3. 데이터 수집 단계에서 쓸 값들을 설정합니다. 슬라이더를 움직이거나 숫자 입력을 통해 설정을 바꿀 수 있습니다.",
      img : HelpOne_three}
  ],
  helpTwo : [
    {desc :  "1. 원하는 라벨의 이름을 입력합니다.",
      img : HelpTwo_one},
    {desc : "2. 기록하기 버튼을 누르고 키트를 통해 해당 라벨의 데이터 수집을 시작합니다.",
      img : HelpTwo_two},
    {desc : "3. 원하는 만큼 데이터를 수집할 수 있습니다.",
      img : HelpTwo_three}
  ],
  helpThree : [
