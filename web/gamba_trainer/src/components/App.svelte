...
<Router {url} {basepath}>
  ...
  <!-- 예제 선택 페이지 -->
  <Route path="/motionApps-select"
    ><App_Select><MotionApps /></App_Select></Route
  >
  <Route path="/speechApps-select"
    ><App_Select><SpeechApps /></App_Select></Route
  >
  <Route path="/visionApps-select"
    ><App_Select><VisionApps /></App_Select></Route
  >
  <!-- fui 페이지 -->
