...
-->
<script>
  import Logo from "@motion/components/general/Logo";
  // import { onMount, onDestroy } from "svelte";
  // import { connect, disconnect } from "@motion/stores/bleInterfaceStore/actions";
  ...
  import BASE_PATH from "../../../../components/App.svelte";
  // let dropDownVisible;
