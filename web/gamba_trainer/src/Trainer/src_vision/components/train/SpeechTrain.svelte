<script>
  ...
  import TrainerTrain from "./TrainerTrain.svelte";
  import {
    trainEpochs,
    trainingState,
    trainIsUnlocked,
  ...
  import { getJsonModelFile } from "../../stores/aggregatedActions";

  function handleGetJsonFile() {
    const model = getJsonModelFile();
  }
...
<div>
  <button on:click={handleGetJsonFile()}></button>
</div>
<TrainerTrain>
