...
<div class='description'>
  ...
  <p class="subhead-1">
    Create a new label to record data for each voice data. A minimum of two voice datas
    and three samples of each voice data is required to train your model, though we
    recommend recording at least 10 samples for better results. Choosing a lower
