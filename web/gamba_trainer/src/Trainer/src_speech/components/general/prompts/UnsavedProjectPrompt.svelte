...
<Prompt>
  <div class="inner">
    ...
    <div class="row">
      <button class="button primary prompt-button" on:click={handleStartNew} tabindex="1"
        >No, start a new project</button
      >
      <button class="button primary prompt-button" on:click={handleResume} tabindex="2"
