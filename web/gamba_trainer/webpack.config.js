  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        "motion-tf4micro-motion-kit": path.resolve(__dirname, "src/src_motion/tf4micro-motion-kit"),
        "speech-tf4micro-motion-kit": path.resolve(__dirname, "src/src_speech/tf4micro-motion-kit"),
        "vision-tf4micro-motion-kit": path.resolve(__dirname, "src/src_vision/tf4micro-motion-kit"),
        "template-tf4micro-motion-kit": path.resolve(__dirname, "src/src_template/tf4micro-motion-kit"),
      },
