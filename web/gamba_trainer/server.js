...
app.use('/vision-example', express.static('./src/vision_example'));
app.use('/vision-example', express.static('./src/vision_example/web'));

app.use('/tfjs_caltech_71', express.static('./src/Trainer/src_vision/stores/train/tfjs_caltech_71'));
...
app.get('/vision-example', (req, res) => {
  res.sendFile(path.join(__dirname, '/src/vision_example/web/index.html'));
});
