    ...
    if request.method == 'POST':
        try:
            ...
            if error:
                ...
                return send_file(file_data, mimetype='application/octet-stream', download_name=output_filename)
...
def upload_file():
   ...
   if request.method == 'POST':
       ...
       # tmp dir에 tflite_to_c를 저장하는 것으로 추정.
...
# [END app]
>>>>>>> 57262aab6b930274a43e8609d3c8839d6f807797
